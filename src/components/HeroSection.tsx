  ...
  return (
    <section className="relative bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        {/* Main Heading */}
        <h1 className="text-4xl md:text-5xl font-bold mb-4 font-marathi">
        ...
        {/* Secondary Message */}
        <p className="text-lg text-blue-100 mb-8 font-marathi">
        ...
        <a
          href={`/f/${formSlug}`}
          className="inline-block px-8 py-4 bg-white text-blue-600 font-bold text-lg rounded-lg hover:bg-blue-50 transition shadow-lg font-marathi"
        >
          योगदान द्या →
        </a>

        {/* Badges Below CTA */}
        <div className="flex justify-center gap-4 mt-6 text-sm text-blue-100 flex-wrap font-marathi">
          <span>✓ ५ मिनिटे</span>
